...
// Keep InstaPower to one running instance.
...
if (!gotTheLock) {
  ...
  const createWindow = () => {
    mainWindow = new BrowserWindow({
      ...
      webPreferences: {
        ...
        // Give InstaPower its own persistent Instagram session.
  ...
  // If the user launches InstaPower again, focus the existing window.
